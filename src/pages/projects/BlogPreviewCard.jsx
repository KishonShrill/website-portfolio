  ...
  return(
    <main className="blog-preview-card">
      ...
      <main className="preview-card">
        <img className="preview-card__banner" src="/website-portfolio/images/project-assets/illustration-article.svg" alt="Preview Card Banner" />
        ...
        <div>
          <img className="preview-card__profile" src="/website-portfolio/images/project-assets/image-avatar.webp" alt="Author Profile Picture" />
