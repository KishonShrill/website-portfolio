...
const QrCodeComponent = (props) => {
  ...
  return(
    <>
      <div className="card">
        <img src="/website-portfolio/images/project-assets/image-qr-code.png" alt="" />
      ...
      <div className="attribution">
        ...
        <p className="web">Go back <a href="/website-portfolio/" target="_self"> Home</a>.</p>
        <p className="phone">Go back <a href="/website-portfolio/" target="_self"> Home</a>.</p>
      </div>
    </>
  )
}
